...
const Navbar = () => {
    ...
    return ( 
        <div className="flex w-full justify-between h-[10vh] items-center">
            <div className="w-fit rounded-lg  mt-3 ml-8 flex items-center text-5xl text-center text-green-500">
              <div className="rounded-full"> <FaSpotify /> </div>
              <div className="text-2xl text-white font-semibold ml-2">Spoofify</div>
            </div>
            <div className="relative mt-4 flex w-fit justify-center items-center gap-4 mr-[30%] group">
